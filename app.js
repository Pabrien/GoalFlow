...
const legacyStorageKey = "paskra-state-v1";
...
const translations = {
  ja: {
    ...
    "introStory.aria": "Cevoaの初回説明",
    "introStory.kicker": "はじめてのCevoa",
    "introStory.skip": "あとで見る",
    "introStory.prev": "戻る",
    "introStory.next": "次へ",
    "introStory.begin": "はじめる",
    "introStory.start": "Cevoaを始める",
    "introStory.replay": "i",
    "introStory.page": "{current} / {total}",
    "introStory.0.label": "",
    "introStory.0.title": "Cevoaへようこそ",
    "introStory.0.body":
      "Cevoaは、目標から逆算して\n今日やることを決めるアプリです。",
    "introStory.1.label": "",
    ...
    "insight.kicker": "Cevoaの考え方",
    "insight.buddy.title": "小さく続けるための考え方",
    "insight.buddy.body":
      "Cevoaでは、やる気を大きくするより、迷う時間を小さくすることを大事にします。今日やることが1つ見えていれば、調子が悪い日でも行動に入りやすくなります。完璧な計画より、今日残せる小さな記録が次の日の自分を助けます。",
    "insight.noGoal.title": "目標がない時は、理由を1つだけ残す",
    "insight.noGoal.body":
      "最初から完璧な計画を作る必要はありません。Cevoaでは、まず「なぜ続けたいのか」を目標に残します。理由が見えると、タスクが増えても判断の軸がぶれにくくなります。",
    ...
    "insight.task.body":
      "続かない計画の多くは、タスクが大きすぎます。Cevoaでは、目標をそのまま頑張るのではなく、英単語30個、腕立て10回、資料を1ページ読む、のように今日動けるサイズへ変えます。小さいほど始めやすく、記録も残しやすくなります。",
    ...
    "next.done.buddyMessage":
      "完了が記録に変わりました。この小さい積み上げがCevoaの中心です。",
    ...
    "tutorial.step0.title": "Cevoaの流れを試す",
    "tutorial.step0.body":
  ...
  en: {
    ...
    "app.tagline": "",
    "app.heroCopy":
      "Cevoa breaks goals into small tasks and shows only what to do today.",
    ...
    "introStory.aria": "Cevoa introduction",
    "introStory.kicker": "First time with Cevoa",
    "introStory.skip": "Watch later",
    "introStory.prev": "Back",
    "introStory.next": "Next",
    "introStory.begin": "Start",
    "introStory.start": "Start Cevoa",
    "introStory.replay": "i",
    "introStory.page": "{current} / {total}",
    "introStory.0.label": "",
    "introStory.0.title": "Welcome to Cevoa",
    "introStory.0.body":
      "Cevoa helps you work backward from a goal and decide what to do today.",
    "introStory.1.label": "",
    ...
    "insight.kicker": "Cevoa thinking",
    "insight.buddy.title": "How to keep going quietly",
    "insight.buddy.body":
      "Cevoa cares less about forcing motivation and more about reducing the time spent wondering what to do. When one next action is visible, even a low-energy day can still move. A small record today is more useful than a perfect plan you never touch.",
    "insight.noGoal.title": "When there is no goal, keep one reason",
    "insight.noGoal.body":
      "You do not need a perfect plan at the beginning. Cevoa starts by keeping the reason you want to continue. When the reason is visible, it becomes easier to choose the next action later.",
    ...
    "insight.task.body":
      "Plans usually break when the next step is too large. Cevoa turns the goal into actions like 30 words, 10 pushups, or one page. Smaller tasks are easier to start, easier to place on today, and easier to record.",
    ...
    "next.done.buddyMessage":
      "Completion turned into a record. That small accumulation is the heart of Cevoa.",
    ...
    "tutorial.step0.title": "Try the Cevoa loop",
    "tutorial.step0.body":
...
function renderToday() {
  ...
  items
    ...
    .forEach((item) => {
      ...
      node.addEventListener("click", (event) => {
        if (
          event.target.closest("button, input, textarea, select, form, label")
        )
          return;
...
if ("serviceWorker" in navigator && window.location.protocol !== "file:") {
  window.addEventListener("load", () => {
    navigator.serviceWorker
      .register("./sw.js?v=20260603-goalflow-unified")
